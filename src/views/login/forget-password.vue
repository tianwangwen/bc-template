<template>
  <div class="login login-common-style">
    <login-wrap>
      <el-form v-if="isSend === false" ref="form" :model="dataForm" class="form-container" :rules="rules">
        <div class="logoWrap">
        ...
        <el-form-item style="margin-top: 32px">
          <el-button v-loading="loading" type="primary" class="button" @click="handleClickLogin">发送邮件</el-button>
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    async onLogin() {
      this.loading = true
      const data = await UserApi.forgetPwd({
        ...this.dataForm,
    ...
    // goModifyPass() {
    //   this.$router.push({ path: '/update-password', query: { token: this.tempToken } })
    // },
    // updatePassword() {
